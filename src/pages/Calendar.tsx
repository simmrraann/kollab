    ...
    >
      ...
      {isModalOpen && selectedDate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-3 md:p-4 animate-in fade-in duration-200">
          <div className="bg-background border w-full max-w-md p-4 md:p-6 rounded-xl md:rounded-2xl shadow-2xl scale-100 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center gap-2 mb-4 md:mb-6">
              <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground">Add new content scheduled for this day</p>
              </div>
              <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-secondary rounded-full transition-colors flex-shrink-0">
                  <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-3 md:space-y-4">
               ...
               <div className="space-y-1.5">
                  ...
                  <input required className="w-full rounded-lg border bg-secondary/30 px-3 py-2 md:py-2.5 text-sm focus:ring-2 ring-primary/20 outline-none transition-all" 
               ...
               <div className="grid grid-cols-2 gap-3 md:gap-4">
                   <div className="space-y-1.5">
                      ...
                      <select className="w-full rounded-lg border bg-secondary/30 px-3 py-2 md:py-2.5 text-sm outline-none" 
                   ...
                   <div className="space-y-1.5">
                      ...
                      <input type="number" required className="w-full rounded-lg border bg-secondary/30 px-3 py-2 md:py-2.5 text-sm outline-none" 
               ...
               <div className="space-y-1.5">
                  ...
                  <input className="w-full rounded-lg border bg-secondary/30 px-3 py-2 md:py-2.5 text-sm outline-none" 
                         value={formData.deliverable} 
                         onChange={e => setFormData({...formData, deliverable: e.target.value})} 
                         placeholder="e.g. Reel + Story" />
               </div>

               <Button type="submit" disabled={saving} className="w-full mt-2 md:mt-4" size="lg">
