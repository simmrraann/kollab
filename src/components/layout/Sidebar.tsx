...
import { LayoutDashboard, Briefcase, Calendar, BarChart2, Sparkles, Settings, Moon, Sun, Palette } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  const navItems = [
    ...
    { icon: Palette, label: 'Studio', path: '/studio' }, // NEW STUDIO LINK
  ...
  return (
    ...
    <aside className="hidden md:flex h-screen w-64 bg-card border-r z-50 flex-col transition-colors duration-300 fixed left-0 top-0">
